...
*End of Task 1. Prompt user: "⏸️ Task 1 Complete! Type 'next' to proceed to Task 2 (Data Extraction Tables)."*
...
-------------------------------------------------------------------------------
Compile and generate a downloadable, multi-tab Microsoft Excel Workbook (`.xlsx`) containing all structured extraction outputs from Tasks 1 through 4, including all reconciled and recovered disclosures from Task 4 Part D.
