# Microsoft Copilot Studio ΓÇö FY25 ESG Master Agent & Skill Integration Guide
...
## ≡ƒ¢á∩╕Å Copilot Studio Architecture & Flow
...
```
                               ...
                               Γöé       Copilot Studio Main Agent              Γöé
...
Γöé Task 1: Scope & Operational Audit ΓöÇΓöÇΓû║ Pause: "Type 'next'" ΓöÇΓöÇΓû║ User: "next"                            Γöé
Γöé   Γåô (Pass Task 1 Output as Context)                                                                    Γöé
Γöé Task 2: ESG & Financial Data (FY25 STRICT ONLY) ΓöÇΓöÇΓû║ Pause: "Type 'next'" ΓöÇΓöÇΓû║ User: "next"               Γöé
Γöé   Γåô (Pass Tasks 1 & 2 Outputs as Context)                                                              Γöé
Γöé Task 3: YoY Variance Analysis (1-Yr FY24 Baseline, >=20%) ΓöÇΓöÇΓû║ Pause: "Type 'next'" ΓöÇΓöÇΓû║ User: "next"     Γöé
Γöé   Γåô (Pass Tasks 1, 2 & 3 Outputs as Context)                                                           Γöé
Γöé Task 4: Auditor & QC Mode Combined (Part A: Auditor, Part B: Multi-Location Audit, Part C: Coverage)   Γöé
Γöé   Γåô (Automatic Unpaused Trigger: Pass Tasks 1ΓÇô4 Outputs as Context)                                    Γöé
Γöé Task 5: Consolidated Excel Workbook (.xlsx) Generation ΓöÇΓöÇΓû║ Output: Company-Named Multi-Tab .xlsx File  Γöé
