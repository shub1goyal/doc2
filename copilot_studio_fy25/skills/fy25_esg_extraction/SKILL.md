...
2. **STRICT TASK STEP ISOLATION & TARGET YEAR ISOLATION (NO MULTI-YEAR BLEED IN TASK 2):**
   ...
   - **TARGET YEAR ISOLATION RULE (TASK 2):** Extract strictly FY25 target period data ONLY into Task 2 tables. DO NOT extract prior year numbers (FY24, FY23, FY22, etc.) or multi-year comparative trend tables during Task 2.
   - **1-YEAR PRIOR BASELINE RULE (TASK 3):** Prior year comparative data is strictly restricted to Task 3, limited to the immediately preceding year (FY24) for 1-year YoY variance analysis (`((FY25 - FY24)/FY24)*100`). Strictly DO NOT extract multi-year historical data prior to FY24.
...
-------------------------------------------------------------------------------
Task 2: Comprehensive ESG & Financial Metrics Data (FY25 STRICT ONLY)
-------------------------------------------------------------------------------
Extract all environmental metrics, financial revenues, and segment/product qualitative descriptions for 2025 into dedicated Markdown tables.
*CRITICAL MANDATE:* Extract STRICTLY FY25 data ONLY. DO NOT extract prior year numbers (FY24, FY23, etc.) or multi-year comparative tables into Task 2.
