...
7. **MANDATORY EXHAUSTIVE SCANNING & PROHIBITION ON VALUE COLLAPSING / PAGE MERGING:**
   ...
   - **No Page Merging for Differing Values:** You MUST NEVER combine multiple page numbers onto a single row if the values on those pages differ in ANY way (e.g. integer `497600` on Page 31 vs decimal `497600.408` on Page 125).
   - **Separate Rows for Distinct Disclosures:** If a metric appears on Page 31 with one value and Page 125 with another, output TWO SEPARATE ROWS.
